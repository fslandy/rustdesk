...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "cysklm9642".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.8889642.xyz"];
pub const PUBLIC_RS_PUB_KEY: &str = "auelQyy4haEhPVCZXovFmhat1C4lpD38iPxLG07ryF4=";
